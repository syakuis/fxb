package org.fxb.configure.mybatis;
...
import org.fxb.configure.PropertiesConfiguration;
...
public class MyBatisConfiguration {
  ...
  @Bean
  @Autowired
  public static MapperScannerConfigurer MapperScannerConfigurer(Config config) throws Exception {
