...
import org.fxb.module.data.mybatis.domain.Member;
import org.fxb.module.data.mybatis.domain.User;
...
@ComponentScan(basePackages = "org.fxb.module.data.mybatis")
class DemoDAOSetting {
  ...
  public BasicDataSource dataSource() {
    ...
    dataSource.setUrl("jdbc:h2:mem:fxb;DB_CLOSE_DELAY=-1");
    return dataSource;
  }
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
    ...
    entityManagerFactoryBean.setPackagesToScan("org.fxb.module.data.mybatis");
